...
export default function Footer() {
    return (
        <div className="footer flex-col bottom-0 h-40 sm:h-1/3">
            <div className="flex my-4 sm:my-8 mx-4">
                <p className="text-white text-md sm:text-xl font-bold font-ibm">SupplyAlly</p>
            </div>
            <hr className="border-t-2 border-white-300" />
            <div className="flex items-center flex-wrap mx-4 my-4 sm:mb-12 text-white text-xs md:text-xxs font-family-ibm">
